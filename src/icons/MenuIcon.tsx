...
export const MenuIcon = ({style, onClick}: DotSeparatorIconProps) => (
    <svg onClick={onClick} style={style} width="30" height="30" viewBox="0 0 30 30" fill="currenColor" xmlns="http://www.w3.org/2000/svg">
